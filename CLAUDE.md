...
- **Entitlements File**: `Config/MonsterFoundry.entitlements` contains all app capabilities
...
To add capabilities to your app, edit `Config/MonsterFoundry.entitlements`:
